...
/**
 * โมดูลจัดการส่วนแสดงผล (UI) สำหรับระบบครัว
 * ดูแลการแสดงผลและการโต้ตอบกับผู้ใช้ในระบบครัว
 */

class UIModuleKitchen {
    constructor() {
    ...
    showNotification(message, type = 'info', duration = 5000) {
        ...
        // กำหนดสีตามประเภท
        const colors = {
            'success': { bg: '#2ecc71', border: '#27ae60', icon: 'check-circle' },
            'error': { bg: '#e74c3c', border: '#c0392b', icon: 'exclamation-circle' },
            'warning': { bg: '#f39c12', border: '#d68910', icon: 'exclamation-triangle' },
            'info': { bg: '#3498db', border: '#2980b9', icon: 'info-circle' }
        };
...
export default UIModuleKitchen;